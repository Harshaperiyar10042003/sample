...
const CourseHeader = () => {
  ...
  const defaultHeaders = [
    { title: "AWS", id: 1 },
  { title: "Data Visualisation", id: 2 },
  { title: "Full Stack Development", id: 3 },
  { title: "Java and Spring", id: 4 },
  { title: "Photography", id: 5 },
  { title: "Quality Assurance", id: 6 },
  { title: "Salesforce CRM", id: 7 },
  ];
  ...
  try {
    const response = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/categories`);
