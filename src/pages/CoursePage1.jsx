...
const preloadedCourse = location.state?.courseData;
 ...
 useEffect(() => {
  // ✅ If course is already passed via navigation, use it
  if (preloadedCourse) {
    setCourse(preloadedCourse);
    setLoading(false);
    return;
  }
  ...
  const fetchCourse = async () => {
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_SERVER_URL}/get-course/${id}`
      );
  ...
  <div className="flex flex-col lg:flex-row gap-12 lg:h-[calc(100vh-0px)]">
          {/* Left Column - Course Content */}
          <div className="lg:w-2/3 lg:overflow-y-auto lg:h-full">
            {/* About course */}
          ...
          <div className="lg:w-1/3 lg:overflow-y-auto lg:h-full">
            <div>
